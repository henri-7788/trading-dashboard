...
async function main() {
  ...
  await ensureFloatAttr(TRADES_COLLECTION_ID, 'liquidationPrice', false)
  await ensureFloatAttr(TRADES_COLLECTION_ID, 'margin', false)
  await ensureFloatAttr(TRADES_COLLECTION_ID, 'fundingFee', false)
